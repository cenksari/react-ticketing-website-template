...
const Discover = () => {
  ...
  return (
    <Master>
      ...
      <CardGroup title='Latest events' color='blue' link='/discover' background='gray'>
        <EventCard
          from='20'
          color='blue'
      ...
      <CardGroup title='More events' color='red' link='/discover' background='white'>
        <EventCard
          from='20'
          color='red'
          when='Tue, Sep 21, 2024 19:00'
      ...
      <CardGroup title='Editors pick' color='orange' link='/discover' background='gray'>
        <EventCard
          from='20'
          color='orange'
          when='Tue, Sep 21, 2024 19:00'
      ...
      <CardGroup title='For kids' color='purple' link='/discover' background='white'>
        <EventCard
          from='20'
          color='purple'
          when='Tue, Sep 21, 2024 19:00'
